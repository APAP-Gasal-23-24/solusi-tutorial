...
public class PenerbitRestController {
    ...
    @GetMapping(value = "/penerbit/huruf-awal/{hurufAwal}")
    public List<Penerbit> getPenerbitRestWithPrefix(@PathVariable("hurufAwal") String prefix){
        return penerbitRestService.getPenerbitByHurufAwal(prefix);
    }

    @GetMapping(value = "/penerbit/sorted/by-nama-penerbit")
    public List<Penerbit> getSortedPenerbitByNamaPenerbit(){
        return penerbitRestService.getPenerbitOrderedByNamaPenerbit();
    }
